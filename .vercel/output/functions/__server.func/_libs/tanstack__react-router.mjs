import { r as reactExports, j as jsxRuntimeExports, W as We } from "./react.mjs";
...
function ClientOnly({ children, fallback = null }) {
  return useHydrated() ? /* @__PURE__ */ jsxRuntimeExports.jsx(We.Fragment, { children }) : /* @__PURE__ */ jsxRuntimeExports.jsx(We.Fragment, { children: fallback });
}
function useHydrated() {
  return We.useSyncExternalStore(subscribe, () => true, () => false);
}
function subscribe() {
  return () => {
  };
...
var Route = class extends BaseRoute {
  ...
  */
  constructor(options) {
    ...
    this.Link = We.forwardRef((props, ref) => {
