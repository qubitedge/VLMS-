...
export const branches: Branch[] = [
  { code: "IT", title: "Information Technology", subtitle: "IT Labs", level: "Advanced", labs: 30, hours: 45, topics: ["C Programming", "Python", "Java", "Data Structures using C Programming", "OS", "DBMS", "Machine Learning"], icon: Code2, tint: "from-cyan/20 to-transparent" },
];
