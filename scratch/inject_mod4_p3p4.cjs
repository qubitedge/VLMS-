...
const parsedPath = path.resolve(__dirname, "mod4_p3p4_parsed.json");
...
// Slicing questions
const w4_3_pre = allQuestions.slice(0, 25);
const w4_3_post = allQuestions.slice(25, 50);
const w4_4_pre = allQuestions.slice(50, 75);
const w4_4_post = allQuestions.slice(75, 80);

const experiments = [
  { id: "llms-w4-3", pretest: w4_3_pre, posttest: w4_3_post },
  { id: "llms-w4-4", pretest: w4_4_pre, posttest: w4_4_post },
];
...
console.log(`\n✅ Done injecting Module 4 Part 3 and Part 4 questions!`);
